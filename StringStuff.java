...
public class StringStuff {
   ...
   */
   public static String evensOnly( String s ) {
     ...
     while ( a < (s.length() - 1)){
       int b = 0;
       if (evens.contains(Character.toString(s.charAt(a)))){
         c = c.concat(Character.toString(s.charAt(a)));
         }
        a = a + 1;
       }
     System.out.print(c);
   ...
   */
   public static String oddsOnly( String s ) {
     ...
     while ( a < (s.length() - 1)){
       int b = 0;
       if (odds.contains(Character.toString(s.charAt(a)))){
         c = c.concat(Character.toString(s.charAt(a)));
         }
        a = a + 1;
       }
   ...
   */
   public static String evensOnlyNoDupes( String s ) {
     ...
     while ( a < (s.length() - 1)){
       int b = 0;
       if (evens.contains(Character.toString(s.charAt(a))) && (!c.contains(Character.toString(s.charAt(a))))){
         c = c.concat(Character.toString(s.charAt(a)));
         }
        a = a + 1;
       }
   ...
   */
   public static String oddsOnlyNoDupes( String s ) {
     ...
     while ( a < (s.length() - 1)){
       int b = 0;
       if (odds.contains(Character.toString(s.charAt(a))) && (!c.contains(Character.toString(s.charAt(a))))){
         c = c.concat(Character.toString(s.charAt(a)));
         }
        a = a + 1;
       }
